...
* [ima.copilot](https://www.ima.copilot.com/)
* [文心助手](https://chat.baidu.com/)
* [文心智能体平台](https://agents.baidu.com/center)
* [MiniMax Agent](https://agent.minimaxi.com/)
* [ai工具集](https://ai-bot.cn/)
* [天工](https://www.tiangong.cn/)
* [百灵大模型](https://chat.ant-ling.com/chat)
* [问小白](https://www.wenxiaobai.com/)
* [书生](https://chat.intern-ai.org.cn/)
...
* [open-design:The open-source Claude Design alternative. 🖥️ Local-first desktop app. 🖼️ Your coding agent becomes the design engine: prototypes, landing pages, dashboards, slides, images & video — real files, HTML/PDF/PPTX/MP4 export. 🤖 Claude Code / Codex / Cursor / Gemini / OpenCode / Qwen & 20+ CLIs via BYOK.](https://github.com/nexu-io/open-design)
...
* [CowAgent: Open-source super AI assistant & Agent Harness. Plans tasks, runs tools and skills, self-evolves with memory and knowledge. Multi-model, multi-channel. Lightweight, extensible, one-line install. ](https://github.com/zhayujie/CowAgent)
* [agno: Build, run, and manage your own agent platform.](https://github.com/agno-agi/agno)
* [nanobot: Lightweight, open-source AI agent for your tools, chats, and workflows.](https://github.com/HKUDS/nanobot)
* [500-AI-Agents-Projects: The 500 AI Agents Projects is a curated collection of AI agent use cases across various industries. It showcases practical applications and provides links to open-source projects for implementation, illustrating how AI agents are transforming sectors such as healthcare, finance, education, retail, and more.](https://ashishpatel26.github.io/500-AI-Agents-Projects/)
* [nocobase: NocoBase is an open-source AI + no-code platform for building business systems fast. Instead of generating everything from scratch, AI works on top of production-proven infrastructure and a WYSIWYG no-code interface, so you get both speed and reliability.](https://github.com/nocobase/nocobase)
* [openfang: Open-source Agent Operating System](https://github.com/RightNow-AI/openfang)
* [agency-agents-zh](https://github.com/jnMetaCode/agency-agents-zh)
* [AG-UI: the Agent-User Interaction Protocol. Bring Agents into Frontend Applications.](https://github.com/ag-ui-protocol/ag-ui)
* [MaxKB: MaxKB is an open-source platform for building enterprise-grade agents.](https://github.com/1panel-dev/MaxKB/)
* [joyagent-jdgenie: 开源的端到端产品级通用智能体](https://github.com/jd-opensource/joyagent-jdgenie)

### Coding Agent
* [Claude Code](https://github.com/anthropics/claude-code)
* [OpenCode: The open source coding agent.](https://opencode.ai/)
* [Qoder](https://qoder.com.cn/)
* [Trae](https://www.trae.cn/)
* [CodeBuddy](https://www.codebuddy.cn/home/)
* [文心快码](https://comate.baidu.com/zh)
* [讯飞iflycode](https://www.xfyun.cn/solutions/iflycode)
* [CodeFuse: 让研发变得更简单](https://codefuse.ai/zh-CN)
* [Google Antigravity: Experience liftoff with the next-gen agent platform](https://antigravity.google/)
* [kiro: Move beyond AI coding to agentic engineering](https://kiro.dev/)
* [Devin: the AI software engineer](https://devin.ai/)
* [GitHub Copilot: Command your craft](https://github.com/features/copilot)
...
* [plandex: Open source AI coding agent. Designed for large projects and real world tasks.](https://github.com/plandex-ai/plandex)
* [codex: Lightweight coding agent that runs in your terminal](https://github.com/openai/codex)
* [qwen-code: An open-source AI coding agent that lives in your terminal.](https://github.com/QwenLM/qwen-code)
* [Prometheus: A Knowledge-Graph-Driven AI Agent that maps, understands, and repairs complex codebases — not by guessing, but by reasoning.](https://github.com/EuniAI/Prometheus)
* [SWE-agent: SWE-agent takes a GitHub issue and tries to automatically fix it, using your LM of choice. It can also be employed for offensive cybersecurity or competitive coding challenges.](https://github.com/SWE-agent/SWE-agent)
...
* [codefuse-chatbot: An intelligent assistant serving the entire software development lifecycle, powered by a Multi-Agent Framework, working with DevOps Toolkits, Code&Doc Repo RAG, etc.](https://github.com/codefuse-ai/codefuse-chatbot)
* [PR Agent: The Original Open-Source PR Reviewer.](https://github.com/The-PR-Agent/pr-agent)
* [openinterpreter: A lightweight coding agent for open models like Deepseek, Kimi, and Qwen](https://github.com/openinterpreter/openinterpreter)
...
* [Eigent: The Open Source Cowork Desktop to Unlock Your Exceptional Productivity. Local and Free Alternative to Claude Cowork.](https://github.com/eigent-ai/eigent)
* [Open-Claude-Cowork: OpenSource Claude Cowork. A desktop AI assistant that helps you with programming, file management, and any task you can describe.](https://github.com/DevAgentForge/Open-Claude-Cowork)
...
* [DeepResearch: Tongyi Deep Research, the Leading Open-source Deep Research Agent](https://github.com/Alibaba-NLP/DeepResearch)
* [gpt-researcher: An autonomous agent that conducts deep research on any data using any LLM providers](https://github.com/assafelovic/gpt-researcher)
...
* [Test-Agent: Agent that empowers software testing with LLMs; industrial-first in China](https://github.com/codefuse-ai/Test-Agent)
* [Maestro: Painless E2E Automation for Mobile and Web](https://github.com/mobile-dev-inc/Maestro)

### GUI Agent
* [ShowUI: Open-source, End-to-end, Vision-Language-Action model for GUI Agent & Computer Use.](https://github.com/showlab/ShowUI)
* [AgentCPM-GUI: An on-device GUI agent for operating Android apps, enhancing reasoning ability with reinforcement fine-tuning for efficient task execution.](https://github.com/OpenBMB/AgentCPM-GUI)
...
* [Mobile-Agent: The Powerful GUI Agent Family](https://github.com/X-PLUG/MobileAgent)
* [OS-Copilot: An self-improving embodied conversational agent seamlessly integrated into the operating system to automate our daily tasks.](https://github.com/OS-Copilot/OS-Copilot)
* [UFO³: Weaving the Digital Agent Galaxy](https://github.com/microsoft/UFO)
...
* [CordysCRM: 由飞致云匠心打造的新一代的开源 AI CRM 系统，深度融合信息化、数字化与智能化能力，支持私有化部署，全面保障企业数据安全与主权](https://github.com/1Panel-dev/CordysCRM)
* [SQLBot: 基于大模型和 RAG 的智能问数系统，对话式数据分析神器](https://github.com/dataease/SQLBot)
* [PentestGPT: Automated Penetration Testing Agentic Framework Powered by Large Language Models](https://github.com/GreyDGL/PentestGPT)
...
* [shimmy: Pure-Rust WebGPU inference engine — OpenAI-API compatible, GGUF native, runs on any GPU. No Python. No llama.cpp. Single binary.](https://github.com/Michael-A-Kuykendall/shimmy)
...
* [happy-llm: 从零开始构建大模型](https://github.com/datawhalechina/happy-llm)
* [dive-into-llms: 《动手学大模型Dive into LLMs》系列编程实践教程](https://github.com/Lordog/dive-into-llms)
* [llm-universe: 动手学大模型应用开发](https://datawhalechina.github.io/llm-universe)
* [llm-action: 本项目旨在分享大模型相关技术原理以及实战经验（大模型工程化、大模型应用落地）](https://github.com/liguodongiot/llm-action)
...
* [LLMAgentPapers: Must-read Papers on LLM Agents.](https://github.com/zjunlp/LLMAgentPapers)
* [LLM-Agent-Paper-List: The paper list of the 86-page SCIS cover paper "The Rise and Potential of Large Language Model Based Agents: A Survey" by Zhiheng Xi et al.](https://github.com/WooooDyy/LLM-Agent-Paper-List)
* [Introduction to Claude Skills](https://platform.claude.com/cookbook/skills-notebooks-01-skills-introduction)
* [awesome-claude-skills: A curated list of awesome Claude Skills, resources, and tools for customizing Claude AI workflows](https://github.com/travisvn/awesome-claude-skills)
* [claude-cookbooks: A collection of notebooks/recipes showcasing some fun and effective ways of using Claude.](https://github.com/anthropics/claude-cookbooks)
* [The Agent Skills Directory](https://www.skills.sh/)
* [Ollama 教程](https://www.runoob.com/ollama/ollama-tutorial.html)
* [vLLM 中文站](https://vllm.hyper.ai/docs/)
* [vbgate/learn-opencode: OpenCode 中文实战课源码与内容仓库：一课一页，覆盖入门到实战工作流)(https://github.com/vbgate/learn-opencode)
* [ZeroZ-lab/learn-opencode](https://github.com/ZeroZ-lab/learn-opencode)
* [awesome-claude-code: A hand-picked collection of the finest of resources for the most awesome of agents, Claude Code, the undisputed champion of coding companions, from the unstoppable team at Anthropic PBC. A delectable showcase of top tier skills, ambidextrous agents, scintillating status lines, top notch developer tooling, and also we have plugins](https://github.com/hesreallyhim/awesome-claude-code)
* [claude-code-tips: 40+ tips for getting the most out of Claude Code, from basics to advanced - includes a custom status line script and Claude Code running itself in a container. Also includes the dx plugin: skills for everyday dev workflows.](https://github.com/ykdojo/claude-code-tips)
* [learn-claude-code: Bash is all you need - A nano claude code–like 「agent harness」, built from 0 to 1](https://github.com/shareAI-lab/learn-claude-code)
